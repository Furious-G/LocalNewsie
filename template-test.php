...
<div class="gridContain">
        ...
        <div class="leftBar">
            <img src="https://staging10.localnewsie.com/wp-content/themes/JointsWP-CSS-master/assets/images/mainlogo.png">
            <ul>
...
<!-- <div class="flourish-embed flourish-map" data-src="visualisation/10430482"><script src="https://public.flourish.studio/resources/embed.js"></script></div> -->
        <div class="grid-x grid-padding-x align-center range">
            <div class="large-11 cell align-center">
                ...
                <div class="text text-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur consectetur nec odio at mattis. Integer et tortor lobortis, molestie dui porta, bibendum dui. <strong>Use the sliders to estimate future equity</strong>.
                </div>
