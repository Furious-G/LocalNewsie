<?php
/*
Template Name: Revenue Forecast UK
*/

get_header(); ?>
<style type="text/css">
    
.revenue .tValue::before {
    content: "£";
}
</style>
<div class="container">
                    ...
                    <div class="large-10 cell top-title">
                        ...
                        <div class="grid-x grid-padding-x grid-padding-y align-right">
                            <div class="large-11 cell porel">
                                ...
                                <div class="align-right flex-container revTotals align-middle">
                                    <div class="tycimage text-center"><span></span></div>
                                    <div class="text-center">
                                        Local Newsie Annual Income: <span class="tValue newsieIncome">0.00</span></div>
